...
resource "github_repository" "app-enviroment" {
  name        = "${var.application_name}-enviroment"
  description = "My TF awesome codebase"
...
resource "github_branch" "tf_dev" {
  repository = github_repository.app-enviroment.name
  branch     = "dev"
}

resource "github_branch" "tf_qa" {
  repository = github_repository.app-enviroment.name
  branch     = "qa"
}

resource "github_branch" "tf_preprod" {
  repository = github_repository.app-enviroment.name
  branch     = "preprod"
}
...
resource "github_repository_file" "tf-dev" {
  repository          = github_repository.app-enviroment.name
  branch              = github_branch.tf_dev.branch
...
resource "github_repository_file" "tf-qa" {
  repository          = github_repository.app-enviroment.name
  branch              = github_branch.tf_qa.branch
...
resource "github_repository_file" "tf-preprod" {
  repository          = github_repository.app-enviroment.name
  branch              = github_branch.tf_preprod.branch
