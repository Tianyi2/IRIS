...
resource sqlChatwydataapphost7882d1d3f8SqlDataFileShare 'Microsoft.Storage/storageAccounts/fileServices/shares@2022-05-01' = {
  parent: storageVolumeFileService
  name: take('${toLower('sql')}-${toLower('chatwydataapphost7882d1d3f8sqldata')}', 60)
  properties: {
    shareQuota: 1024
...
resource sqlChatwydataapphost7882d1d3f8SqlDataStore 'Microsoft.App/managedEnvironments/storages@2023-05-01' = {
  parent: containerAppEnvironment
  name: take('${toLower('sql')}-${toLower('chatwydataapphost7882d1d3f8sqldata')}', 32)
  properties: {
    azureFile: {
      shareName: sqlChatwydataapphost7882d1d3f8SqlDataFileShare.name
...
output SERVICE_SQL_VOLUME_CHATWYDATAAPPHOST7882D1D3F8SQLDATA_NAME string = sqlChatwydataapphost7882d1d3f8SqlDataStore.name
