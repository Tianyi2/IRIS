...
param containerAppsNsgName string
...
resource containerAppsNsg 'Microsoft.Network/networkSecurityGroups@2020-07-01' = {
  name: containerAppsNsgName
  location: location
  tags: union(tags, { 'azd-service-name': containerAppsNsgName })
  properties: {
    securityRules: []
  }
}
    ...
    subnets: [
      ...
      }
      {
        ...
        properties: {
          ...
          networkSecurityGroup: containerAppsNsg.id == '' ? null : {
...
output containerAppsSubnetName string = virtualNetwork::containerAppsSubnet.name
output containerAppsSubnetId string = virtualNetwork::containerAppsSubnet.id
