...
resource keyVault 'Microsoft.KeyVault/vaults@2023-07-01' existing = if (azureKeyvaultSecretsProviderEnabled && !empty(keyVaultName)) {
  name: keyVaultName
}
...
resource keyVaultCSIdriverSecretsUserRoleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = if (azureKeyvaultSecretsProviderEnabled) {
  name: guid(keyVault.id, 'CSIDriver', keyVaultAdministratorRoleDefinition.id)
  scope: keyVault
  properties: {
