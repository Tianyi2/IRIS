...
var iotHubName = '${toLower(prefix)}iothub'
var storageAccountName = '${toLower(prefix)}san'
var storageEndpoint = '${toLower(prefix)}se'
var storageContainerName = '${toLower(prefix)}scn'
