...
resource vm 'Microsoft.Compute/virtualMachines@2020-06-01' = {
  ...
  properties: {
    ...
    osProfile: {
      ...
      linuxConfiguration: any(authenticationType == 'password' ? null : linuxConfiguration) // TODO: workaround for https://github.com/nholuongut/bicep-declarative-language/issues/449
    }
  }
}
