...
@description('Specifies the front subnet resource id.')
param frontSubnetId string

@description('Specifies the back subnet resource id.')
param backSubnetId string

@description('Specifies the front private IP address.')
param frontPrivateIPAddress string

@description('Specifies the back private IP address.')
param backPrivateIPAddress string
    ...
    ipConfigurations: [
      {
        ...
        properties: {
          ...
          privateIPAddress: frontPrivateIPAddress
    ...
    ipConfigurations: [
      {
        ...
        properties: {
          ...
          privateIPAddress: backPrivateIPAddress
          privateIPAllocationMethod: 'Static'
        }
      }
    ]
