...
var subnets = union(
      ...
      array(applicationGatewaySubnet)
    )

// Resources

// Network Security Groups
resource bastionSubnetNsg 'Microsoft.Network/networkSecurityGroups@2024-01-01' = if (bastionHostEnabled) {
...
// NAT Gateway
resource natGatewayPublicIp 'Microsoft.Network/publicIPAddresses@2024-01-01' =  [for i in range(0, natGatewayPublicIps): if(natGatewayEnabled) {
...
resource natGateway 'Microsoft.Network/natGateways@2024-01-01' = if(natGatewayEnabled) {
  name: natGatewayName
  location: location
  sku: {
    name: 'Standard'
...
// Azure Bastion Host
resource bastionPublicIpAddress 'Microsoft.Network/publicIPAddresses@2024-01-01' = if (bastionHostEnabled) {
...
resource bastionHost 'Microsoft.Network/bastionHosts@2024-01-01' = if (bastionHostEnabled) {
...
resource blobStorageAccountPrivateDnsZoneGroupName 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2024-01-01' = {
...
resource keyVaultPrivateDnsZoneGroupName 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2024-01-01' = {
...
resource acrPrivateEndpoint 'Microsoft.Network/privateEndpoints@2024-01-01' = if (createAcrPrivateEndpoint) {
...
resource acrPrivateDnsZoneGroup 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2024-01-01' = if (createAcrPrivateEndpoint) {
